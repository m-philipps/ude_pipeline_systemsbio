...
Run 15 000 starts on the observable_ab_ratio problem, using hyperparaemters with comparatively small regularization settings. 
"""

hps_file_path = "3_start_points/boehm_observable_ab_ratio/hps.csv"
